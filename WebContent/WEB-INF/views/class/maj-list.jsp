...
<body class="pos-r">
	<div>
		<nav class="breadcrumb">
			...
			专业管理 <span class="c-gray en">&gt;</span> 专业列表 <a
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"><a href="javascript:;" onclick="datadel()"
					...
					onclick="maj_add('添加专业','${pageContext.request.contextPath }/maj/showadd')"
					href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加专业</a>
				</span>
			</div>
			<form action="maj/mutidel" id="myform" method="post">
			<div class="mt-20">
				<table
					...
					<c:forEach items="${mlist}" var="m">
						<tr class="text-c va-m">
		                    ...
		                    <td class="text-l">${m.id}</td>
		                    <td class="text-l">${m.name}</td>
		                    <td class="text-l">${m.remark}</td>
		                    <td>
		                    <a href="maj/mutidel1?mid=${m.id}" class="btn btn-danger radius">删除</a>
		                    <a  class="btn btn-primary radius"
								onClick="maj_edit('专业编辑','maj/showadd','${m.id}')"
