...
<body>
  <div class="page-container">
      <form:form action="${pageContext.request.contextPath}/cou/save" modelAttribute="course" method="post">
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>课程姓名：</label>
