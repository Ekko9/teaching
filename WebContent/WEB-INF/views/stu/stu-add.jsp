...
<body>
  ...
  <form:form action="${pageContext.request.contextPath}/stu/save" modelAttribute="student" method="post" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>学生姓名：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>所在班级：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                <form:select path="majid" class="select">
                    <form:option value="0">----请选择专业----</form:option>
                </form:select>
                <form:select path="classid" class="select">
                     <form:option value="0">----请选择班级----</form:option>
                </form:select>
                <form:errors path="classid"></form:errors>
				</span> </div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <form:input path="address" size="50" class="input-text"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			    <form:input path="tel" size="50" class="input-text"/>
